            ...
            child: Column(
              ...
              children: [
                ...
                buildText(
                  ...
                  value: appStore.currencyPosition == LEFT
                      ? '${appStore.currencyCode} ${Utils.formatPrice(invoice.totalAmount)}'
                      : '${Utils.formatPrice(invoice.totalAmount)} ${appStore.currencyCode} ',
                  unite: true,
                ),
              ],
            ),
